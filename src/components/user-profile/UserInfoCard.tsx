...
export default function UserInfoCard() {
  ...
  useEffect(() => {
    const fetchUserInfo = async () => {
      try {
        ...
        addAlert("error", "Error", "Failed to fetch user info");
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleEditClick = () => {
    ...
    console.log("Opening modal with formData:", formData); // Debug log
    openModal();
  };
  ...
  const handleSave = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      console.log("Submitting update request:", formData); // Debug log
      await api.post("/profile/users/update", formData);
      setUser({
        ...user!,
      ...
      addAlert("error", "Error", "Cannot update user information!");
    }
  };
